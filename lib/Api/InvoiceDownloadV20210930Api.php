...
/**
 * InvoiceDownloadV20210930Api Class Doc Comment
 *
 * @category Class
 * @package  AmazonBusinessApi
 */
class InvoiceDownloadV20210930Api
{
    /**
     * @var ClientInterface
     */
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList',
     ...
     *
     * @param  \AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportSpecification $body body (required)
     *
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportResponse
     */
     ...
     *
     * @param  \AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportSpecification $body (required)
     *
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createReportWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportResponse', $response->getHeaders());
                case 400:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList', $response->getHeaders());
                case 401:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\CreateReportResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonBusinessApi\Model\InvoiceDownloadV20210930\Report
     */
     ...
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonBusinessApi\Model\InvoiceDownloadV20210930\Report, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportWithHttpInfo($report_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\Report' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\Report', $response->getHeaders());
                case 400:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\Report';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\Report',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonBusinessApi\Model\InvoiceDownloadV20210930\ReportDocument
     */
     ...
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonBusinessApi\Model\InvoiceDownloadV20210930\ReportDocument, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportDocumentWithHttpInfo($report_document_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ReportDocument' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ReportDocument', $response->getHeaders());
                case 400:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ReportDocument';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ReportDocument',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AmazonBusinessApi\Model\InvoiceDownloadV20210930\GetReportsResponse
     */
     ...
     * @throws \AmazonBusinessApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AmazonBusinessApi\Model\InvoiceDownloadV20210930\GetReportsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportsWithHttpInfo($report_types = null, $processing_statuses = null, $marketplace_ids = null, $page_size = 10, $created_since = null, $created_until = null, $next_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\GetReportsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\GetReportsResponse', $response->getHeaders());
                case 400:
                    if ('\AmazonBusinessApi\Model\InvoiceDownloadV20210930\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\GetReportsResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AmazonBusinessApi\Model\InvoiceDownloadV20210930\GetReportsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getReportsRequest($report_types = null, $processing_statuses = null, $marketplace_ids = null, $page_size = 10, $created_since = null, $created_until = null, $next_token = null)
    {
        if ($report_types !== null && count($report_types) > 10) {
            throw new \InvalidArgumentException('invalid value for "$report_types" when calling InvoiceDownloadV20210930Api.getReports, number of items must be less than or equal to 10.');
        }
        if ($report_types !== null && count($report_types) < 1) {
            throw new \InvalidArgumentException('invalid value for "$report_types" when calling InvoiceDownloadV20210930Api.getReports, number of items must be greater than or equal to 1.');
        }

        if ($processing_statuses !== null && count($processing_statuses) < 1) {
            throw new \InvalidArgumentException('invalid value for "$processing_statuses" when calling InvoiceDownloadV20210930Api.getReports, number of items must be greater than or equal to 1.');
        }

        if ($marketplace_ids !== null && count($marketplace_ids) > 10) {
            throw new \InvalidArgumentException('invalid value for "$marketplace_ids" when calling InvoiceDownloadV20210930Api.getReports, number of items must be less than or equal to 10.');
        }
        if ($marketplace_ids !== null && count($marketplace_ids) < 1) {
            throw new \InvalidArgumentException('invalid value for "$marketplace_ids" when calling InvoiceDownloadV20210930Api.getReports, number of items must be greater than or equal to 1.');
        }

        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling InvoiceDownloadV20210930Api.getReports, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling InvoiceDownloadV20210930Api.getReports, must be bigger than or equal to 1.');
        }
