...
/**
 * SearchFacetType Class Doc Comment
 *
 * @category Class
...
class SearchFacetType
{
    ...
    public function __construct($value)
    {
        if (is_null($value) || !in_array($value, self::getAllowableEnumValues(), true)) {
            throw new \InvalidArgumentException(sprintf("Invalid value for enum 'SearchFacetType', must be one of '%s'", implode("', '", self::getAllowableEnumValues())));
        }
