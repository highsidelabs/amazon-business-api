 ...
 */
class SubCategory extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * Sets display_name
     *
     * @param string $display_name Display name is used to share more human friendly readable description of sub category.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The search subcategory id identify a search sub category uniquely across a product region.
     *
     * @return self
     */
