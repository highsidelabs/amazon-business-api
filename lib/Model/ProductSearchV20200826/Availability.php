 ...
 */
class Availability extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * Sets display_name
     *
     * @param string $display_name Availability display name would be more user friendly to illustrate the meaning of its id.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Availability id  uniquely identify a availability option, client can sent back the id to filter asins belonging to given availability option.
     *
     * @return self
     */
