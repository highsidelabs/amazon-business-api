...
/**
 * EligibleForFreeShipping Class Doc Comment
 *
 * @category Class
 ...
 */
class EligibleForFreeShipping extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EligibleForFreeShipping';
     ...
     * Sets display_name
     *
     * @param string $display_name EligibleForFreeShipping display name is used to share more human friendly readable description.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id EligibleForFreeShipping id would identify the search to be Free Shipping by Amazon only.
     *
     * @return self
     */
