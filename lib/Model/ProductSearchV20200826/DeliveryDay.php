 ...
 */
class DeliveryDay extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryDay';
     ...
     * Sets display_name
     *
     * @param string $display_name DeliveryDay display name is used to share more human friendly readable description.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id DeliveryDay id would identify the search regrading to it is Get It Today or Get It by Tomorrow.
     *
     * @return self
     */
