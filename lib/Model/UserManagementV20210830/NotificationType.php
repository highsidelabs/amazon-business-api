 ...
 *
 * @category Class
 * @description The types of notification to suppress.
 * @package  AmazonBusinessApi
 * @group 
 */
class NotificationType
{
    ...
    public function __construct($value)
    {
        if (is_null($value) || !in_array($value, self::getAllowableEnumValues(), true)) {
            throw new \InvalidArgumentException(sprintf("Invalid value for enum 'NotificationType', must be one of '%s'", implode("', '", self::getAllowableEnumValues())));
        }
