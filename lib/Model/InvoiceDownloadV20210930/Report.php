...
class Report implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * Sets report_id
     *
     * @param string $report_id The identifier for the report. This identifier is unique only in combination with a business entity.
     *
     * @return self
     */
     ...
     *
     * @param string|null $data_start_time The start of a date and time range used for selecting the data to report.
     *
     * @return self
     */
     ...
     * Sets data_end_time
     *
     * @param string|null $data_end_time The end of a date and time range used for selecting the data to report.
     *
     * @return self
     */
