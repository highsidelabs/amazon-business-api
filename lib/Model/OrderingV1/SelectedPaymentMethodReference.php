...
/**
 * SelectedPaymentMethodReference Class Doc Comment
 *
 * @category Class
 * @description The payment method where the charges for the order will apply. This attribute can only be passed at order level.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class SelectedPaymentMethodReference extends Attribute 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelectedPaymentMethodReference';
