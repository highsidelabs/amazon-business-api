 ...
 *
 * @category Class
 * @description A textual string referring to the email of the user.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class UserEmail extends UserReference 
{
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((!preg_match("/^[\\w-\\.\\+]+@([\\w-]+\\.)+[\\w-]{2,4}$/", $email_address))) {
            throw new \InvalidArgumentException("invalid value for $email_address when calling UserEmail., must conform to the pattern /^[\\w-\\.\\+]+@([\\w-]+\\.)+[\\w-]{2,4}$/.");
        }
