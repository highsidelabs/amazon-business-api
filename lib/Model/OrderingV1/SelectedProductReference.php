...
/**
 * SelectedProductReference Class Doc Comment
 *
 * @category Class
 * @description Contains a reference to the product to order. This attribute can be passed at line-item or order level. If passed at order level, the product reference will apply to all line items that has no set attribute.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class SelectedProductReference extends Attribute 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelectedProductReference';
