...
/**
 * PhysicalAddressAllOf Class Doc Comment
 *
 * @category Class
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class PhysicalAddressAllOf extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhysicalAddress_allOf';
    ...
    public function setFullName($full_name)
    {
        ...
        if ((mb_strlen($full_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $full_name when calling PhysicalAddressAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling PhysicalAddressAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling PhysicalAddressAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PhysicalAddressAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setStateOrRegion($state_or_region)
    {
        ...
        if ((mb_strlen($state_or_region) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_or_region when calling PhysicalAddressAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling PhysicalAddressAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for $country_code when calling PhysicalAddressAllOf., must conform to the pattern /^[A-Z]{2}$/.");
        }
