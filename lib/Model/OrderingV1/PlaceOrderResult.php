...
/**
 * PlaceOrderResult Class Doc Comment
 *
 * @category Class
 * @description The result of a request to place an order. Specifies how line items in the request were broken up into ordered and rejected portions.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class PlaceOrderResult extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlaceOrderResult';
