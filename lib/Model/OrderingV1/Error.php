...
class Error extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
     ...
     * Sets message
     *
     * @param string $message A message describing the error condition.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param string|null $details Additional details to help the caller understand or fix the issue.
     *
     * @return self
     */
