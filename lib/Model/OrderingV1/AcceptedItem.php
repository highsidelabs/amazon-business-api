...
/**
 * AcceptedItem Class Doc Comment
 *
 * @category Class
 * @description A portion of requested item quantity that was successfully ordered.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class AcceptedItem extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcceptedItem';
    ...
    protected static $openAPITypes = [
        'quantity' => 'int',
        'artifacts' => '\AmazonBusinessApi\Model\OrderingV1\AcceptanceArtifact[]'
    ];
     ...
     * Sets quantity
     *
     * @param int $quantity The accepted line item quantity.
     *
     * @return self
     */
     ...
     * Sets artifacts
     *
     * @param \AmazonBusinessApi\Model\OrderingV1\AcceptanceArtifact[] $artifacts Details about the ordered line item quantity.
     *
     * @return self
     */
