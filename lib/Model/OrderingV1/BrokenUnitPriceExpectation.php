...
/**
 * BrokenUnitPriceExpectation Class Doc Comment
 *
 * @category Class
 * @description The unit price exceeds the expected limit, which led to order rejection. This artifact will appear at rejected-item level.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class BrokenUnitPriceExpectation extends RejectionArtifact 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrokenUnitPriceExpectation';
