...
/**
 * AgeRestriction Class Doc Comment
 *
 * @category Class
 * @description A non-compliance with the age limit requirement results in order rejection. This artifact will appear at rejected-item level.
 * @package  AmazonBusinessApi
 * @group 
 ...
 */
class AgeRestriction extends RejectionArtifact 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgeRestriction';
     ...
     * Sets minimum_age
     *
     * @param float $minimum_age The minimum age required to purchase the item.
     *
     * @return self
     */
